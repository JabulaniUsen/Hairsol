  ...
  return (
    <div className='payment'>
      <div className="text-center flex flex-col justify-center my-24">
        <h1 className='call-header text-xl font-bold'>Get more exposure and accept <br />all payment types</h1>
        <p className="call-text w-[400px] lg:w-[500px] m-auto my-5 ">
          Clients can pay with a credit or debit card, Klarna, Apply Pay, Google Pay, or
